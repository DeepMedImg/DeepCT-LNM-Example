...
from nnunet.inference.predict_attmap import predict_from_folder
...
def main():
    ...
    parser.add_argument("-att", '--attmap_folder', help="Files must be named CASENAME_attmap.nii.gz", required=True)
    ...
    attmap_folder = args.attmap_folder
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        predict_from_folder(model_folder_name, input_folder, attmap_folder, lowres_output_folder, folds, False,
    ...
    predict_from_folder(model_folder_name, input_folder, attmap_folder, output_folder, folds, save_npz, num_threads_preprocessing,
