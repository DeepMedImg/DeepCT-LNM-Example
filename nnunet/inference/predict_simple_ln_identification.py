...
from nnunet.inference.predict_classification import predict_from_folder
...
def main():
    ...
    parser.add_argument("-seg", '--seg_folder', help="Files must be named CASENAME.nii.gz", required=True)
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        predict_from_folder(model_folder_name, input_folder, seg_folder, lowres_output_folder, folds, False,
    ...
    predict_from_folder(model_folder_name, input_folder, seg_folder, output_folder, folds, save_npz, num_threads_preprocessing,
