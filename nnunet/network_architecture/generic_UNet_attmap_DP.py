...
class Generic_UNet_Attmap_DP(Generic_UNet_Attmap):
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_UNet_Attmap_DP, self).__init__(input_channels, base_num_features, num_classes, num_pool,
                                              num_conv_per_stage,
    ...
    def forward(self, x, a=None, y=None, return_hard_tp_fp_fn=False):
        res = super(Generic_UNet_Attmap_DP, self).forward(x, a)  # regular Generic_UNet forward pass
