...
from nnunet.network_architecture.generic_UNet_attmap_DP import Generic_UNet_Attmap_DP
from nnunet.training.data_augmentation.default_data_augmentation import get_moreDA_augmentation_attmap
from nnunet.training.network_training.nnUNetTrainer_Attention_FRCNN_stage1 import nnUNetTrainer_Attention_FRCNN_stage1
...
class nnUNetTrainer_Attention_FRCNN_stage1_DP(nnUNetTrainer_Attention_FRCNN_stage1):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=1, distribute_batch_size=False, fp16=False):
        super(nnUNetTrainer_Attention_FRCNN_stage1_DP, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
    ...
    def setup_DA_params(self):
        super(nnUNetTrainer_Attention_FRCNN_stage1_DP, self).setup_DA_params()
        self.data_aug_params['num_threads'] = 8 * self.num_gpus

    def process_plans(self, plans):
        super(nnUNetTrainer_Attention_FRCNN_stage1_DP, self).process_plans(plans)
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            if training:
                ...
                self.tr_gen, self.val_gen = get_moreDA_augmentation_attmap(self.dl_tr, self.dl_val,
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet_Attmap_DP(self.num_input_channels, self.base_num_features, self.num_classes,
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        ###############
        ret = self.network(data, attmap, target, return_hard_tp_fp_fn=run_online_evaluation)
